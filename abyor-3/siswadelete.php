...
<?php if ($siswa->tempatLahir->Visible) { // tempatLahir ?>
		<td><span id="elh_siswa_tempatLahir" class="siswa_tempatLahir"><?php echo $siswa->tempatLahir->FldCaption() ?></span></td>
<?php } ?>
<?php if ($siswa->tanggalLahir->Visible) { // tanggalLahir ?>
		<td><span id="elh_siswa_tanggalLahir" class="siswa_tanggalLahir"><?php echo $siswa->tanggalLahir->FldCaption() ?></span></td>
<?php } ?>
...
<?php if ($siswa->noHp->Visible) { // noHp ?>
		<td><span id="elh_siswa_noHp" class="siswa_noHp"><?php echo $siswa->noHp->FldCaption() ?></span></td>
<?php } ?>
...
<span id="el<?php echo $siswa_delete->RowCnt ?>_siswa_tempatLahir" class="control-group siswa_tempatLahir">
...
<span id="el<?php echo $siswa_delete->RowCnt ?>_siswa_tanggalLahir" class="control-group siswa_tanggalLahir">
...
<span id="el<?php echo $siswa_delete->RowCnt ?>_siswa_noHp" class="control-group siswa_noHp">

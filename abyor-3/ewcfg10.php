...
define("EW_PROJECT_NAME", "abyor2D3", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{82E7E539-D0AE-473F-AA71-5A043814ED93}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'Al8jPPeXhGdBQVmo', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/abyor2D3.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", 'dbadministrasi', TRUE);

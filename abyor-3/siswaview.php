...
<?php if ($siswa->tempatLahir->Visible) { // tempatLahir ?>
	<tr id="r_tempatLahir">
		<td><span id="elh_siswa_tempatLahir"><?php echo $siswa->tempatLahir->FldCaption() ?></span></td>
...
<?php echo $siswa->tempatLahir->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($siswa->tanggalLahir->Visible) { // tanggalLahir ?>
	<tr id="r_tanggalLahir">
		<td><span id="elh_siswa_tanggalLahir"><?php echo $siswa->tanggalLahir->FldCaption() ?></span></td>
...
<?php echo $siswa->tanggalLahir->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>

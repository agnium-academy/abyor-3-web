...
class cguru extends cTable {
	...
	function __construct() {
		...
		// tempatLahir
		$this->tempatLahir = new cField('guru', 'guru', 'x_tempatLahir', 'tempatLahir', '`tempatLahir`', '`tempatLahir`', 200, -1, FALSE, '`tempatLahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['tempatLahir'] = &$this->tempatLahir;

		// tanggalLahir
		$this->tanggalLahir = new cField('guru', 'guru', 'x_tanggalLahir', 'tanggalLahir', '`tanggalLahir`', 'DATE_FORMAT(`tanggalLahir`, \'%Y/%m/%d\')', 133, 5, FALSE, '`tanggalLahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// noHp
		$this->noHp = new cField('guru', 'guru', 'x_noHp', 'noHp', '`noHp`', '`noHp`', 200, -1, FALSE, '`noHp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');

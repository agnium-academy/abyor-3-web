...
$guru_view = NULL; // Initialize page object first

class cguru_view extends cguru {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["guru_id"] <> "") {
			$this->RecKey["guru_id"] = $_GET["guru_id"];
			$KeyUrl .= "&amp;guru_id=" . urlencode($this->RecKey["guru_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["guru_id"] <> "") {
				...
				$this->RecKey["guru_id"] = $this->guru_id->QueryStringValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("gurulist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->guru_id->CurrentValue) == strval($this->Recordset->fields('guru_id'))) {
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "gurulist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "gurulist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($guru_view)) $guru_view = new cguru_view();
...
// Page object
var guru_view = new ew_Page("guru_view");
guru_view.PageID = "view"; // Page ID
var EW_PAGE_ID = guru_view.PageID; // For backward compatibility

// Form object
var fguruview = new ew_Form("fguruview");

// Form_CustomValidate event
fguruview.Form_CustomValidate = 
...
fguruview.ValidateRequired = true;
<?php } else { ?>
fguruview.ValidateRequired = false; 
<?php } ?>
...
<?php $guru_view->ExportOptions->Render("body") ?>
<?php if (!$guru_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($guru_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $guru_view->ShowPageHeader(); ?>
<?php
$guru_view->ShowMessage();
?>
<?php if ($guru->Export == "") { ?>
<form name="ewPagerForm" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>">
<table class="ewPager">
<tr><td>
<?php if (!isset($guru_view->Pager)) $guru_view->Pager = new cPrevNextPager($guru_view->StartRec, $guru_view->DisplayRecs, $guru_view->TotalRecs) ?>
<?php if ($guru_view->Pager->RecordCount > 0) { ?>
<table class="ewStdTable"><tbody><tr><td>
	<?php echo $Language->Phrase("Page") ?>&nbsp;
<div class="input-prepend input-append">
<!--first page button-->
	<?php if ($guru_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $guru_view->PageUrl() ?>start=<?php echo $guru_view->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-backward"></i></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($guru_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $guru_view->PageUrl() ?>start=<?php echo $guru_view->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $guru_view->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($guru_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $guru_view->PageUrl() ?>start=<?php echo $guru_view->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($guru_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $guru_view->PageUrl() ?>start=<?php echo $guru_view->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $guru_view->Pager->PageCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
...
<?php } ?>
<form name="fguruview" id="fguruview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="guru">
<table class="ewGrid"><tr><td>
<table id="tbl_guruview" class="table table-bordered table-striped">
...
<?php echo $guru->nip->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $guru->nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $guru->tempatLahir->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $guru->tanggalLahir->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $guru->alamat->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $guru->agama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $guru->noHp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $guru->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>

...
class cnilai extends cTable {
	...
	function __construct() {
		...
		// nis
		$this->nis = new cField('nilai', 'nilai', 'x_nis', 'nis', '`nis`', '`nis`', 200, -1, FALSE, '`nis`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nis'] = &$this->nis;

		// nip
		$this->nip = new cField('nilai', 'nilai', 'x_nip', 'nip', '`nip`', '`nip`', 200, -1, FALSE, '`nip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "d_nilai") {
			$sDetailUrl = $GLOBALS["d_nilai"]->GetListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&nilai_id=" . $this->nilai_id->CurrentValue;
		}
		if ($sDetailUrl == "") {

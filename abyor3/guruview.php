...
<?php if ($guru->tempat_lahir->Visible) { // tempat_lahir ?>
	<tr id="r_tempat_lahir">
		<td><span id="elh_guru_tempat_lahir"><?php echo $guru->tempat_lahir->FldCaption() ?></span></td>
...
<?php echo $guru->tempat_lahir->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($guru->tanggal_lahir->Visible) { // tanggal_lahir ?>
	<tr id="r_tanggal_lahir">
		<td><span id="elh_guru_tanggal_lahir"><?php echo $guru->tanggal_lahir->FldCaption() ?></span></td>
...
<?php echo $guru->tanggal_lahir->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>

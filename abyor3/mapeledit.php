...
$mapel_edit = NULL; // Initialize page object first

class cmapel_edit extends cmapel {
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->id_mapel->CurrentValue == "")
			$this->Page_Terminate("mapellist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// nama_mapel
			$this->nama_mapel->SetDbValueDef($rsnew, $this->nama_mapel->CurrentValue, "", $this->nama_mapel->ReadOnly);
...
// Create page object
if (!isset($mapel_edit)) $mapel_edit = new cmapel_edit();

// Page init
$mapel_edit->Page_Init();

// Page main
$mapel_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$mapel_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var mapel_edit = new ew_Page("mapel_edit");
mapel_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = mapel_edit.PageID; // For backward compatibility

// Form object
var fmapeledit = new ew_Form("fmapeledit");

// Validate form
fmapeledit.Validate = function() {
...
fmapeledit.Form_CustomValidate = 
...
fmapeledit.ValidateRequired = true;
<?php } else { ?>
fmapeledit.ValidateRequired = false; 
<?php } ?>
...
<?php $mapel_edit->ShowPageHeader(); ?>
<?php
$mapel_edit->ShowMessage();
?>
<form name="fmapeledit" id="fmapeledit" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="mapel">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_mapeledit" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_id_mapel" name="x_id_mapel" id="x_id_mapel" value="<?php echo ew_HtmlEncode($mapel->id_mapel->CurrentValue) ?>">

...
$detail_nilai_add = NULL; // Initialize page object first

class cdetail_nilai_add extends cdetail_nilai {
	...
	// Page object name
	var $PageObjName = 'detail_nilai_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["id_detail_nilai"] != "") {
				...
				$this->setKey("id_detail_nilai", $this->id_detail_nilai->CurrentValue); // Set up key
			} else {
				$this->setKey("id_detail_nilai", ""); // Clear key
...
// Create page object
if (!isset($detail_nilai_add)) $detail_nilai_add = new cdetail_nilai_add();

// Page init
$detail_nilai_add->Page_Init();

// Page main
$detail_nilai_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$detail_nilai_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var detail_nilai_add = new ew_Page("detail_nilai_add");
detail_nilai_add.PageID = "add"; // Page ID
var EW_PAGE_ID = detail_nilai_add.PageID; // For backward compatibility

// Form object
var fdetail_nilaiadd = new ew_Form("fdetail_nilaiadd");

// Validate form
fdetail_nilaiadd.Validate = function() {
...
fdetail_nilaiadd.Form_CustomValidate = 
...
fdetail_nilaiadd.ValidateRequired = true;
<?php } else { ?>
fdetail_nilaiadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdetail_nilaiadd.Lists["x_id_mapel"] = {"LinkField":"x_id_mapel","Ajax":null,"AutoFill":false,"DisplayFields":["x_nama_mapel","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $detail_nilai_add->ShowPageHeader(); ?>
<?php
$detail_nilai_add->ShowMessage();
?>
<form name="fdetail_nilaiadd" id="fdetail_nilaiadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="detail_nilai">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_detail_nilaiadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fdetail_nilaiadd.Lists["x_id_mapel"].Options = <?php echo (is_array($detail_nilai->id_mapel->EditValue)) ? ew_ArrayToJson($detail_nilai->id_mapel->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php if (strval($detail_nilai->id_nilai->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_id_nilai" id="x_id_nilai" value="<?php echo ew_HtmlEncode(strval($detail_nilai->id_nilai->getSessionValue())) ?>">
<?php } ?>
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
</form>
<script type="text/javascript">
fdetail_nilaiadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$detail_nilai_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$detail_nilai_add->Page_Terminate();
?>

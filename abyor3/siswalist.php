...
class csiswa_list extends csiswa {
	...
	function BasicSearchSQL($Keyword) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->tempat_lahir, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $this->alamat, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $this->agama, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $this->no_hp, $Keyword);
...
<?php if ($siswa->tempat_lahir->Visible) { // tempat_lahir ?>
	<?php if ($siswa->SortUrl($siswa->tempat_lahir) == "") { ?>
		<td><div id="elh_siswa_tempat_lahir" class="siswa_tempat_lahir"><div class="ewTableHeaderCaption"><?php echo $siswa->tempat_lahir->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $siswa->SortUrl($siswa->tempat_lahir) ?>',1);"><div id="elh_siswa_tempat_lahir" class="siswa_tempat_lahir">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $siswa->tempat_lahir->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($siswa->tempat_lahir->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($siswa->tempat_lahir->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($siswa->tanggal_lahir->Visible) { // tanggal_lahir ?>
	<?php if ($siswa->SortUrl($siswa->tanggal_lahir) == "") { ?>
		<td><div id="elh_siswa_tanggal_lahir" class="siswa_tanggal_lahir"><div class="ewTableHeaderCaption"><?php echo $siswa->tanggal_lahir->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $siswa->SortUrl($siswa->tanggal_lahir) ?>',1);"><div id="elh_siswa_tanggal_lahir" class="siswa_tanggal_lahir">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $siswa->tanggal_lahir->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($siswa->tanggal_lahir->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($siswa->tanggal_lahir->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($siswa->alamat->Visible) { // alamat ?>
	<?php if ($siswa->SortUrl($siswa->alamat) == "") { ?>
		<td><div id="elh_siswa_alamat" class="siswa_alamat"><div class="ewTableHeaderCaption"><?php echo $siswa->alamat->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $siswa->SortUrl($siswa->alamat) ?>',1);"><div id="elh_siswa_alamat" class="siswa_alamat">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $siswa->alamat->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($siswa->alamat->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($siswa->alamat->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
...
<?php if ($siswa->no_hp->Visible) { // no_hp ?>
	<?php if ($siswa->SortUrl($siswa->no_hp) == "") { ?>
		<td><div id="elh_siswa_no_hp" class="siswa_no_hp"><div class="ewTableHeaderCaption"><?php echo $siswa->no_hp->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $siswa->SortUrl($siswa->no_hp) ?>',1);"><div id="elh_siswa_no_hp" class="siswa_no_hp">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $siswa->no_hp->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($siswa->no_hp->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($siswa->no_hp->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		

...
class cdefault {
	...
	function Page_Main() {
		...
		$this->Page_Terminate("detail_nilailist.php"); // Exit and go to default page
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("gurulist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("mapellist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("nilailist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("siswalist.php");
		if ($Security->IsLoggedIn()) {

...
<?php if ($mapel->kode_mapel->Visible) { // kode_mapel ?>
	<tr id="r_kode_mapel">
		<td><span id="elh_mapel_kode_mapel"><?php echo $mapel->kode_mapel->FldCaption() ?></span></td>
...
<?php echo $mapel->kode_mapel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($mapel->nama_mapel->Visible) { // nama_mapel ?>
	<tr id="r_nama_mapel">
		<td><span id="elh_mapel_nama_mapel"><?php echo $mapel->nama_mapel->FldCaption() ?></span></td>
...
<?php echo $mapel->nama_mapel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>

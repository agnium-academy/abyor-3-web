...
class csiswa extends cTable {
	...
	function __construct() {
		...
		// tempat_lahir
		$this->tempat_lahir = new cField('siswa', 'siswa', 'x_tempat_lahir', 'tempat_lahir', '`tempat_lahir`', '`tempat_lahir`', 200, -1, FALSE, '`tempat_lahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['tempat_lahir'] = &$this->tempat_lahir;

		// tanggal_lahir
		$this->tanggal_lahir = new cField('siswa', 'siswa', 'x_tanggal_lahir', 'tanggal_lahir', '`tanggal_lahir`', 'DATE_FORMAT(`tanggal_lahir`, \'%Y/%m/%d\')', 133, 5, FALSE, '`tanggal_lahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// alamat
		$this->alamat = new cField('siswa', 'siswa', 'x_alamat', 'alamat', '`alamat`', '`alamat`', 200, -1, FALSE, '`alamat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// no_hp
		$this->no_hp = new cField('siswa', 'siswa', 'x_no_hp', 'no_hp', '`no_hp`', '`no_hp`', 200, -1, FALSE, '`no_hp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');

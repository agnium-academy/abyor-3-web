...
<?php if ($guru->tempat_lahir->Visible) { // tempat_lahir ?>
		<td><span id="elh_guru_tempat_lahir" class="guru_tempat_lahir"><?php echo $guru->tempat_lahir->FldCaption() ?></span></td>
<?php } ?>
<?php if ($guru->tanggal_lahir->Visible) { // tanggal_lahir ?>
		<td><span id="elh_guru_tanggal_lahir" class="guru_tanggal_lahir"><?php echo $guru->tanggal_lahir->FldCaption() ?></span></td>
<?php } ?>
...
<?php if ($guru->no_hp->Visible) { // no_hp ?>
		<td><span id="elh_guru_no_hp" class="guru_no_hp"><?php echo $guru->no_hp->FldCaption() ?></span></td>
<?php } ?>
...
<span id="el<?php echo $guru_delete->RowCnt ?>_guru_tempat_lahir" class="control-group guru_tempat_lahir">
...
<span id="el<?php echo $guru_delete->RowCnt ?>_guru_tanggal_lahir" class="control-group guru_tanggal_lahir">
...
<span id="el<?php echo $guru_delete->RowCnt ?>_guru_no_hp" class="control-group guru_no_hp">

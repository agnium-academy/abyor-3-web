...
define("EW_PROJECT_NAME", "abyor_school", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{207FBEFE-7CD7-4EAA-9B3B-698CCFB88A2B}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'ztWf5EC7rVXabUEq', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/abyor_school.css", TRUE); // Project stylesheet file name

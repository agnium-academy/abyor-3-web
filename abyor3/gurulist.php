...
<?php if ($guru->tempat_lahir->Visible) { // tempat_lahir ?>
	<?php if ($guru->SortUrl($guru->tempat_lahir) == "") { ?>
		<td><div id="elh_guru_tempat_lahir" class="guru_tempat_lahir"><div class="ewTableHeaderCaption"><?php echo $guru->tempat_lahir->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $guru->SortUrl($guru->tempat_lahir) ?>',1);"><div id="elh_guru_tempat_lahir" class="guru_tempat_lahir">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $guru->tempat_lahir->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($guru->tempat_lahir->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($guru->tempat_lahir->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($guru->tanggal_lahir->Visible) { // tanggal_lahir ?>
	<?php if ($guru->SortUrl($guru->tanggal_lahir) == "") { ?>
		<td><div id="elh_guru_tanggal_lahir" class="guru_tanggal_lahir"><div class="ewTableHeaderCaption"><?php echo $guru->tanggal_lahir->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $guru->SortUrl($guru->tanggal_lahir) ?>',1);"><div id="elh_guru_tanggal_lahir" class="guru_tanggal_lahir">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $guru->tanggal_lahir->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($guru->tanggal_lahir->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($guru->tanggal_lahir->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
...
<?php if ($guru->no_hp->Visible) { // no_hp ?>
	<?php if ($guru->SortUrl($guru->no_hp) == "") { ?>
		<td><div id="elh_guru_no_hp" class="guru_no_hp"><div class="ewTableHeaderCaption"><?php echo $guru->no_hp->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $guru->SortUrl($guru->no_hp) ?>',1);"><div id="elh_guru_no_hp" class="guru_no_hp">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $guru->no_hp->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($guru->no_hp->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($guru->no_hp->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
...
<span<?php echo $guru->tempat_lahir->ViewAttributes() ?>>
<?php echo $guru->tempat_lahir->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($guru->tanggal_lahir->Visible) { // tanggal_lahir ?>
		<td<?php echo $guru->tanggal_lahir->CellAttributes() ?>>
<span<?php echo $guru->tanggal_lahir->ViewAttributes() ?>>
<?php echo $guru->tanggal_lahir->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($guru->alamat->Visible) { // alamat ?>
...
<span<?php echo $guru->no_hp->ViewAttributes() ?>>
<?php echo $guru->no_hp->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($guru->_email->Visible) { // email ?>
